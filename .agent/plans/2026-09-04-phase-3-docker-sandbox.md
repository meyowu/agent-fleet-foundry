...
- Observation: The host initially had no Docker-compatible CLI/runtime executable in `PATH`.
  ...
  Consequence: The hard gate became runnable rather than being waived. Acceptance pins context `colima`, local endpoint `unix://<local-user-home>/.colima/default/docker.sock`, server 29.5.2, canonical daemon identity `815f9bce2b2930154aaaf49cf86667332a3b576d6b85a92ed070ff9d1a0971fb`, and immutable image `sha256:08a5a9124f184f29018f59c1abbe7015a0498a447d5aecd60b18029316465379`.
...
- Observation: Colima does not share pytest's macOS `/private/var/...` temporary root into its VM by default.
  ...
  Consequence: real-Docker tests use an explicit `--basetemp` beneath `<local-user-home>`; this is a host-runner requirement, not a sandbox relaxation.
