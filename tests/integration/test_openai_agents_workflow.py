...
_KEY = "offline-agents-workflow-credential"
_MODEL = "gpt-test"
...
async def test_real_sdk_workflow_respects_all_broker_decisions_and_retains_evidence(
    tmp_path: Path,
    ...
    assert run.runtime_name == "openai-agents" and run.provider_model == f"openai:{_MODEL}"
